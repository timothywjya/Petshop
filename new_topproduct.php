...
<div class="container">
<form action="save_new_topproduct.php" method="post" enctype="multipart/form-data">
  <div class="mb-3 mt-3">
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="text" class="form-control" id="web" name="web" placeholder="Enter website link" name="email">
  </div>
