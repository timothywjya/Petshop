...
<html lang="en">
    ...
    <body>
        <?php
            ...
            if ($id)
            {
                $sSQL="SELECT * FROM `tb_training` WHERE training_id ='$id' limit 1";
	    ...
	    ?>	 
        <h2>UPDATE DATA TRAINING</h2>
        <form action="applyupdate_training.php" method="post" enctype="multipart/form-data">
            <div class="container">
