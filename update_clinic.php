...
<html lang="en">
    ...
    <body>
        <?php
            ...
            if ($id)
            {
                $sSQL="SELECT * FROM `tb_clinic` WHERE clinic_id ='$id' limit 1";
	    ...
	    ?>	 
        <h2>UPDATE DATA CLINIC</h2>
        <form action="applyupdate_clinic.php" method="post" enctype="multipart/form-data">
            <div class="container">
