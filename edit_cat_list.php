...
<?php
   ...
   $id = $_GET['id'];
   		...
   		$sSQL="";
	    $sSQL=" select * from tb_cat where id='$id' limit 1";
...
<div class="container">
<h1 class="text-center"> Edit cat List </h1>
<form action="save_edit_cat.php" method="post" enctype="multipart/form-data">
  <div class="mb-3 mt-3">
