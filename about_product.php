...
<html>
  ...
  <body>
    <center><h1>List Top Product</h1><center>
    <center><a href="add_product.php">Add Product</a><center><br/>
    <table>
      <thead>
        <tr>
          <th>No</th>
      ...
      <tbody>
        ...
        while($row = mysqli_fetch_assoc($result))
        {
          ...
          <tr>
            ...
            <td style="text-align: center;"><img src="gambar/<?php echo $row['product']; ?>" style="width: 120px;"></td>
            <td>
