...
<div class="container">
<h1 class="text-center"> Edit Dog List </h1>
<form action="save_edit_dog.php" method="post" enctype="multipart/form-data">
  <div class="mb-3 mt-3">
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="text" class="form-control" id="harga" name="harga" placeholder="Enter Price" name="email" value="<?php echo $harga?>">
  </div>
  ...
  <label for="old_file_product" class="form-label">Old File Image</label><br>
  ...
  <a href="dog_list.php"><button type="button" class="btn  btn-danger">Cancel</button></a>
</form> 
</div>
