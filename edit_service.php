...
<body>
    <form method="POST" action="editing_service.php" enctype="multipart/form-data" >
    
    <section class="base">
    <center>
        <h1>Edit Service <?php echo $data['nama']; ?></h1>
    <center>
        ...
        <div>
          ...
          <img src="gambar/<?php echo $data['service']; ?>" style="width: 120px;float: left;margin-bottom: 5px;">
          <input type="file" name="service" />
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak ingin merubah gambar service</i>
        </div><br>
        <div>
