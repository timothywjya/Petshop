        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="services.php#pet_grooming">Pet Grooming</a>
                        <a class="dropdown-item" href="services.php#pet_clinic">Pet Clinic</a>
                        <a class="dropdown-item" href="services.php#pet_training">Pet Training</a>
                        <a class="dropdown-item" href="services.php#pet_hotel">Pet Hotel</a>
                </div>
              </li>
            ...
            <form class="d-flex">
              ...
              <button class="btn btn btn-primary" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
            </form>
          </div>
        </div>
      </nav>
  <!-- Akhir Navbar -->
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="dropdown1">
            ...
            <div class="row">
                    <?php
                    $sSQL="select * from tb_cat where flag_active = 1 ";
